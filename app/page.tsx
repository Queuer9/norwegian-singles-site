        ...
        >
          <section id="intro" className="section mb-24 pb-0 pt-16 scroll-mt-24">
            ...
            <div className="prose prose-lg prose-neutral max-w-none text-[20px] leading-[30px]">
              <p className="mb-6">
                It all started with the <a href="https://www.letsrun.com/forum/flat_read.php?thread=12130781" target="_blank" rel="noopener noreferrer" onClick={(e) => { e.preventDefault(); window.open(e.currentTarget.href, '_blank'); }} className="text-[#111111] border-b border-[#111111] border-opacity-50">best ever thread</a> on the worst site on the internet.
              </p>

              <p className="mb-6">What began in July 2023 as a simple comment by Sirpoc, a then-anonymous amateur runner, has <a href="https://www.strava.com/clubs/1175805" target="_blank" rel="noopener noreferrer" onClick={(e) => { e.preventDefault(); window.open(e.currentTarget.href, '_blank'); }} className="text-[#111111] border-b border-[#111111] border-opacity-50">snowballed into a movement</a>. One that promises PBs across distances from 5K to the marathon while offering a more sustainable way to train, with less fatigue and fewer injuries.</p>

              <p className="mb-6">Some claim Sirpoc has <a href="https://www.reddit.com/r/AdvancedRunning/comments/1k9zx83/has_the_sirpoc_method_solved_hobby_jogging/" target="_blank" rel="noopener noreferrer" onClick={(e) => { e.preventDefault(); window.open(e.currentTarget.href, '_blank'); }} className="text-[#111111] border-b border-[#111111] border-opacity-50">solved hobbyjogging</a>. Whether or not that's true, there's a strong case that most amateur runners would benefit from understanding the Norwegian Singles Method.</p>
              ...
              <p className="mb-6"><a href="https://sites.google.com/view/sub-threshold/home?authuser=0" target="_blank" rel="noopener noreferrer" onClick={(e) => { e.preventDefault(); window.open(e.currentTarget.href, '_blank'); }} className="text-[#111111] border-b border-[#111111] border-opacity-50">Some attempts</a> have been made to consolidate what's known, but Let's Run and Reddit remain full of questions and confident misunderstanding. People keep asking for a book. This isn't it, but it might get close.</p>
          ...
          <section id="background" className="section mb-10 pt-0 scroll-mt-24" style={{ minHeight: '200px' }}>
            ...
            <div className="prose prose-lg prose-neutral max-w-none text-[20px] leading-[30px]">
              <p className="mb-6">Sirpoc is something of an iconoclast.</p>
              <p className="mb-6">He stands apart from other internet-famous runners - there's no YouTube channel, you won't find him on podcasts, and he doesn't offer a <a href="https://www.justalilbester.com/coaching" target="_blank" rel="noopener noreferrer" onClick={(e) => { e.preventDefault(); window.open(e.currentTarget.href, '_blank'); }} className="text-[#111111] border-b border-[#111111] border-opacity-50">£115/month coaching package</a>.</p>
              <p className="mb-6">For someone with a 5K PB of 15:01, there's no sign on his Strava of the lung-busting hero workouts that are the staple of most sub-elite training. In fact, if you follow him on the platform you'll struggle to discern anything interesting - there's no <a href="https://www.instagram.com/reel/DGBW6tDNyi7/" target="_blank" rel="noopener noreferrer" onClick={(e) => { e.preventDefault(); window.open(e.currentTarget.href, '_blank'); }} className="text-[#111111] border-b border-[#111111] border-opacity-50">trip to Kenya</a>, no hills, no x-factor sessions and even the easy runs are slower than most coaches would prescribe.</p>

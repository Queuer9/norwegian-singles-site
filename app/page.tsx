        ...
        >
          <section id="intro" className="section mb-24 pb-0 pt-16 scroll-mt-24">
            ...
            <div className="prose prose-lg prose-neutral max-w-none text-[20px] leading-[30px]">
              <p className="mb-6">It all started with the best ever thread on the worst site on the internet.</p>
              ...
              <p className="mb-6">Some claim Sirpoc has solved hobbyjogging. Whether or not that's true, there's a strong case that most amateur runners would benefit from understanding the Norwegian Singles Method.</p>
              ...
              <p className="mb-6">Some attempts have been made to consolidate what's known, but Let's Run and Reddit remain full of questions and confident misunderstanding. People keep asking for a book. This isn't it, but it might get close.</p>
          ...
          <section id="background" className="section mb-10 pt-0 scroll-mt-24" style={{ minHeight: '200px' }}>
            ...
            <div className="prose prose-lg prose-neutral max-w-none text-[20px] leading-[30px]">
              ...
              <p className="mb-6">He stands apart from other internet-famous runners - there's no YouTube channel, you won't find him on podcasts, and he doesn't offer a £115/month coaching package.</p>
